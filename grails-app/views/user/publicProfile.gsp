    ...
    <div class="popup-wrapper popup-class" id="popup">
        <div class="popup-container"><!-- Popup Contents, just modify with your own -->
            <g:form controller="topic" action="createTopic" class="form-signin2popup" name="userForm">
                ...
                <br/> <g:select name="seriousness"  class="form-control" from="${linksharingapplication.Subscription.SeriousnessValue}"/>
                <br/><g:select name="visibility" class="form-control" from="${linksharingapplication.Topic.VisibilityValue}"/>
